			...
			<?php foreach ($gtk as $i):?>   
			  ...
			  <tbody>
				<tr>
				  ...
				  <td> Rp.<?= $i['harga'];?> </td>
				  <td>
					<a href="<?= base_url('Penginapan/editKamar/'.$i['id'].'/'.$i['image']);?>" class="badge badge-warning"><i class="mdi mdi-lead-pencil"></i> Edit</a>
					<a href="<?= base_url('Penginapan/delete/'.$i['id']);?>" class="badge badge-danger"><i class="mdi mdi-delete"></i> delete</a>
				  </td>
				</tr>
